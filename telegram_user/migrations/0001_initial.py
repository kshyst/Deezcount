    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_code', models.CharField(max_length=15, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_account_name', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('restaurant', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='telegram_user.availablerestaurant')),
            ],
            options={
